...
<ul class="list"><li><a href="index.php">Главная</a></li><li><a href="../">Перейти к сайту</a></li></ul>
   ...
   <div class="headi" style="margin: 10px;">Добавление нового  администратора     </div>
   <table width="100%" border="0">
     <tr>
         <td width="26%" class="ListTableLeftBar">Имя:</td>
         <td width="74%"><input name="name" type="text" style="width: 400px" maxlength="30" />&nbsp;</td>
       </tr>
       <tr>
         <td width="26%" class="ListTableLeftBar">Фамилия:</td>
         <td width="74%"><input name="surname" type="text" style="width: 400px" maxlength="30" />&nbsp;</td>
       </tr>
       <tr>
         <td width="26%" class="ListTableLeftBar">Логин:</td>
         <td width="74%"><input name="login" type="text" style="width: 400px" maxlength="25" />&nbsp;</td>
       </tr>
       <tr>
         <td width="26%" class="ListTableLeftBar">E-mail:</td>
         <td width="74%"><input name="mail" type="text" style="width: 400px" maxlength="32" />&nbsp;</td>
       </tr>
       <tr>
         <td width="26%" class="ListTableLeftBar">Пароль:</td>
